...
uses
  TopazGameLib in '..\sources\TopazGameLib.pas',
  uTopazExamples in 'uTopazExamples.pas',
  uShaders in 'uShaders.pas',
  uActors in 'uActors.pas',
  uVideos in 'uVideos.pas',
